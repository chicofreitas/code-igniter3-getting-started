...
<html lang="en" data-bs-theme="auto">
  <head><script src="<?php echo base_url();?>assets/js/color-modes.js"></script>
    ...
    <meta name="author" content="Chico Freitas, and Bootstrap contributors">
  ...
  <body>
    ...
    <div class="dropdown position-fixed bottom-0 end-0 mb-3 me-3 bd-mode-toggle">
      <button class="btn btn-bd-primary py-2 dropdown-toggle d-flex align-items-center"
        ...
        <span class="visually-hidden" id="bd-theme-text">Mudar modo</span>
      </button>
				...
				<div class="offcanvas-md offcanvas-end bg-custom-blue" tabindex="-1" id="sidebarMenu" aria-labelledby="sidebarMenuLabel">
					...
					<div class="offcanvas-body bg-custom-blue d-md-flex flex-column p-0 pt-lg-3 overflow-y-auto">
						<ul class="nav flex-column">
							...
							<li class="nav-item">
								<a class="nav-link d-flex align-items-center gap-2" href="#">
									<svg class="bi largeicon"><use xlink:href="#file-earmark"/></svg>
									<!-- Orders -->
								</a>
							</li>
							<li class="nav-item">
								<a class="nav-link d-flex align-items-center gap-2" href="#">
									<svg class="bi largeicon"><use xlink:href="#cart"/></svg>
									<!-- Products -->
								</a>
							</li>
							<li class="nav-item">
								<a class="nav-link d-flex align-items-center gap-2" href="#">
									<svg class="bi largeicon"><use xlink:href="#people"/></svg>
									<!-- Customers -->
								</a>
							</li>
							<li class="nav-item">
								<a class="nav-link d-flex align-items-center gap-2" href="#">
									<svg class="bi largeicon"><use xlink:href="#graph-up"/></svg>
									<!-- Reports -->
								</a>
							</li>
							<li class="nav-item">
								<a class="nav-link d-flex align-items-center gap-2" href="#">
									<svg class="bi largeicon"><use xlink:href="#puzzle"/></svg>
									<!-- Integrations -->
								</a>
							</li>
						</ul>
						...
						<ul class="nav flex-column mb-auto">
							<li class="nav-item">
							<a class="nav-link d-flex align-items-center gap-2" href="#">
								<svg class="bi largeicon"><use xlink:href="#gear-wide-connected"/></svg>
								<!-- Configurações -->
							</a>
							</li>
							<li class="nav-item">
							<a class="nav-link d-flex align-items-center gap-2" href="#">
								<svg class="bi largeicon"><use xlink:href="#door-closed"/></svg>
								<!-- Sair -->
							</a>
							</li>
						</ul>
